...
class ConversationService:
    ...
    async def create_conversation(
        user_id: int, title: str = "新会话", thread_id: str = None,
        dialogue_type: DialogueType = DialogueType.AGENT,
    ) -> int:
        """创建新会话，可关联 Agent 的 thread_id"""
        async with AsyncSessionLocal() as db:
            ...
            logger.info(f"Created conversation {conversation.id} (thread={thread_id}) for user {user_id}")
